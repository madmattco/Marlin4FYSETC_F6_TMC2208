...
//
  ...
  //#define _TMC2208_DEFINE_SOFTWARE(ST) TMC2208Stepper stepper##ST(ST##_SERIAL_RX_PIN, ST##_SERIAL_TX_PIN,false) 
...
/*
	SoftwareSerial stepperX_serial = SoftwareSerial(X_SERIAL_RX_PIN, X_SERIAL_TX_PIN);
	SoftwareSerial stepperY_serial = SoftwareSerial(Y_SERIAL_RX_PIN, Y_SERIAL_TX_PIN);
	SoftwareSerial stepperZ_serial = SoftwareSerial(Z_SERIAL_RX_PIN, Z_SERIAL_TX_PIN);
	SoftwareSerial stepperE0_serial = SoftwareSerial(E0_SERIAL_RX_PIN, E0_SERIAL_TX_PIN);

	TMC2208Stepper stepperX(&stepperX_serial,false);
		TMC2208Stepper stepperY(&stepperY_serial,false);
		TMC2208Stepper stepperZ(&stepperZ_serial,false);
		TMC2208Stepper stepperE0(&stepperE0_serial,false);
*/		
/*
	TMC2208Stepper stepperX(X_SERIAL_RX_PIN, X_SERIAL_TX_PIN,false);
	TMC2208Stepper stepperY(Y_SERIAL_RX_PIN, Y_SERIAL_TX_PIN,false);
	TMC2208Stepper stepperZ(Z_SERIAL_RX_PIN, Z_SERIAL_TX_PIN,false);
	TMC2208Stepper stepperE0(E0_SERIAL_RX_PIN, E0_SERIAL_TX_PIN,false);
*/
  ...
  /*
      ...
      //_TMC2208_INIT(X, planner.axis_steps_per_mm[X_AXIS]);
			tmc2208_init(stepperX, X_MICROSTEPS, X_HYBRID_THRESHOLD, planner.axis_steps_per_mm[X_AXIS]);
    #endif
    #if ENABLED(X2_IS_TMC2208)
      //_TMC2208_INIT(X2, planner.axis_steps_per_mm[X_AXIS]);
			tmc2208_init(stepperX2, X2_MICROSTEPS, X2_HYBRID_THRESHOLD, planner.axis_steps_per_mm[X_AXIS]);
    #endif
    #if ENABLED(Y_IS_TMC2208)
      //_TMC2208_INIT(Y, planner.axis_steps_per_mm[Y_AXIS]);
			tmc2208_init(stepperY, Y_MICROSTEPS, Y_HYBRID_THRESHOLD, planner.axis_steps_per_mm[Y_AXIS]);
    #endif
    #if ENABLED(Y2_IS_TMC2208)
      //_TMC2208_INIT(Y2, planner.axis_steps_per_mm[Y_AXIS]);
			tmc2208_init(stepperY2, Y2_MICROSTEPS, Y2_HYBRID_THRESHOLD, planner.axis_steps_per_mm[Y_AXIS]);
    #endif
    #if ENABLED(Z_IS_TMC2208)
      //_TMC2208_INIT(Z, planner.axis_steps_per_mm[Z_AXIS]);
			tmc2208_init(stepperZ, Z_MICROSTEPS, Z_HYBRID_THRESHOLD, planner.axis_steps_per_mm[Z_AXIS]);
    #endif
    #if ENABLED(Z2_IS_TMC2208)
      //_TMC2208_INIT(Z2, planner.axis_steps_per_mm[Z_AXIS]);
			tmc2208_init(stepperZ2, Z2_MICROSTEPS, Z2_HYBRID_THRESHOLD, planner.axis_steps_per_mm[Z_AXIS]);
    #endif
    #if ENABLED(E0_IS_TMC2208)
      //_TMC2208_INIT(E0, planner.axis_steps_per_mm[E_AXIS]);
			tmc2208_init(stepperE0, E0_MICROSTEPS, E0_HYBRID_THRESHOLD, planner.axis_steps_per_mm[E_AXIS]);
    #endif
    #if ENABLED(E1_IS_TMC2208)
