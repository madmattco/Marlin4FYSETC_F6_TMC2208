...
/**
 * M86: Set inactivity shutdown timer with parameter S<seconds>. To disable set zero (default)
 */
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      case 85: // M85: Set inactivity stepper shutdown timeout
        gcode_M85();
        break;
		      case 86: // M85: Set inactivity stepper shutdown timeout
        gcode_M86();
        break;
...
void setup() {
  ...
  #if ENABLED(HAVE_TMC2208)
    //tmc2208_serial_begin(); fzl:comment 20180807
  #endif
